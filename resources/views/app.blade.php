...
<html lang="en">
	...
	<body>
        <div class="row" style="padding: 20px 0 20px 0">
            ...
            <div class="col-md-2" >
                <img src="images/Logo CMD@2x.png" style="height: 103px !important; width: 362px !important;" />
            </div>
            <div class="col-md-2"></div>
            <div class="col-md-2"></div>
            <div class="col-md-2"></div>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <a style="color: #fff" href="{{url('/auth/register') }}">Registro</a>
                        </li>
                        @else
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu" style="background-color: #62c7f3 !important">
                                ...
                                <li>
                                    <a style="color: #fff" href="{{url('/new-post') }}">Agregar Entrada</a>
                                </li>
                                <li>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
                    <div class="panel panel-primary" style="box-shadow: 8px 1px 8px rgba(0,0,0,0.3); ">
        ...
        <div class="row" id="u3557" style="background-color: #143756; color: white !important; padding: 10px 0;">
            <!-- group -->
