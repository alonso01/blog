	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-heading">Hoja de Registro</div>
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/register') }}">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">Casa Farmaceutica</label>
							<div class="col-md-6">
								<select class="form-control" name="pharmaceutical" value="{{old('pharmaceutical') }}">
                                    <option value="Denk Pharma">Denk Pharma</option>
                                    <option value="Asofarma">Asofarma</option>
